...
class _PantallaDatosState extends State<PantallaDatos> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    proyectosFiltrados = List<Map<String, String>>.from(listaProyectos);
                      ...
                      trailing: PopupMenuButton<String>(
                        ...
                        onSelected: (value) {
                          if (value == 'edit') {
                            ...
                            final realIndex = listaTrabajadores.indexWhere((item) => item["nombre"] == t["nombre"]);
                            if (realIndex != -1) {
                    ...
                    child: ListTile(
                      ...
                      trailing: PopupMenuButton<String>(
                        ...
                        onSelected: (value) {
                          if (value == 'edit') {
                            // Encontrar el índice real en la lista original
                            final realIndex = listaProyectos.indexWhere((item) => item["proyecto"] == p["proyecto"]);
                            if (realIndex != -1) {
  ...
  void _filtrarTrabajadores() {
    ...
    setState(() {
      if (query.isEmpty) {
        ...
        trabajadoresFiltrados = listaTrabajadores.where((trabajador) {
  ...
  void _filtrarProyectos() {
    ...
    setState(() {
      if (query.isEmpty) {
        ...
        proyectosFiltrados = listaProyectos.where((proyecto) {
